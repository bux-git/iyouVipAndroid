...
public final class BarUtils {
     ...
     * @param view 根view
     */
    public static void addRootPadding(View... view) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            return;
        }
        for (View v : view) {
     ...
     * @param view 根view
     */
    public static void removeRootPadding(View... view) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            return;
        }
        for (View v : view) {
    ...
    public static int getActionBarHeight() {
        ...
        if (BaseApplication.get().getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            return TypedValue.complexToDimensionPixelSize(
                    tv.data, BaseApplication.get().getResources().getDisplayMetrics()
            );
        }
        return 0;
    }
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = BaseApplication.get().getSystemService("statusbar");
    ...
    public static int getNavBarHeight() {
        Resources res = BaseApplication.get().getResources();
