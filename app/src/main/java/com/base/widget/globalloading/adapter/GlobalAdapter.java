package com.base.widget.globalloading.adapter;

import android.view.View;

import com.base.widget.globalloading.adapter.view.Constants;
import com.base.widget.globalloading.adapter.view.GlobalLoadingStatusView;
...
public class GlobalAdapter implements Gloading.Adapter {
    ...
    public View getView(Gloading.Holder holder, View convertView, int status) {
        ...
        if (holder.getData() != null) {
            loadingStatusView.setDisPlayData(holder.getData());
        }
